...
{
    public class BLSupplier : IBLWorkService<Supplier>
    {
        public readonly IRepository<Supplier> _repository;
        public BLSupplier(IRepository<Supplier> repository)
        {
        ...
        public async Task<Supplier> GetById(int? Id)
        {
            try
            {
                if (Id != 0)
                {
                    Supplier obj = await _repository.GetById(Id);
                    return obj;
                }
                return null;
            }
        ...
        public async Task<int> Delete(Supplier _obj)
        {
            try
            {
                if (_obj != null)
